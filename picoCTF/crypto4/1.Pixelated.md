...
## SOLUCION
marianardz@LAPTOP-BALAMHAU:~$ vim imag.py
marianardz@LAPTOP-BALAMHAU:~$ cat imag.py
import numpy as np
...
marianardz@LAPTOP-BALAMHAU:~$ xdg-open result.png

![[Pasted image 20260425232841.png]]
