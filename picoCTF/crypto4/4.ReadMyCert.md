...
## SOLUCION
marianardz@LAPTOP-BALAMHAU:~$ file readmycert.csr
readmycert.csr: PEM certificate request
marianardz@LAPTOP-BALAMHAU:~$ cat readmycert.csr
...
marianardz@LAPTOP-BALAMHAU:~$ openssl req -in readmycert.csr -noout -text
Certificate Request:
    Data:
        Version: 1 (0x0)
